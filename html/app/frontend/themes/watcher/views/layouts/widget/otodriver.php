...
<section class="module-news top-margin">
    ...
    <header>
        <h2>
            <a href="http://otodriver.com" target="_blank">
                <img src="http://otodriver.com/image/load/100/0/logo/logo_md.png"/>
            </a>
        </h2>
    ...
    <div class="article-container" id='odContainer'></div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $.ajax({
            url: "http://otodriver.com/rss/newsj?callback=?",
            dataType : 'JSONP',

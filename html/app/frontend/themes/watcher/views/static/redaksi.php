...
$this->title ='Redaksi'. ' | '.Yii::$app->params['comonTitle'];
		...
		<div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <p>REDAKSI<br />PT Bintang Langgeng Media</p>
                    <p>Director : Soni Riharto</p>
                    <p>Editor in Chief&nbsp;: Benny Averdi</p>
                    <p>Editor&nbsp;: Fitra Eri, Hieronimus Girindra</p>
                    <p>Reporter&nbsp;: Ilham Pratama, Danu Purbowiseso Dirgantoro, Hariawan Arif</p>
                    <p>Marketing Manager&nbsp;: Buchari Muslim</p>
                    <p>Advertising&nbsp;: Rima Anissa N, Pamela V</p>
                    <p>Web Developer Manager&nbsp;: Haris</p>
                    <p>Web Developer&nbsp;: Ichtiar Adhika Pamungkas</p>
                    <p>Desainer Grafis&nbsp;: Ignatius Bayu Putu Surono</p>
                    <p>Sekretaris Redaksi&nbsp;: Wuri Handayani</p>
                    <br>
                </div>
            </div>  
			</div>

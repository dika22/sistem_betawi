...
if(! defined('DEBUG_ON') )					define ('DEBUG_ON', 0);								// Enable debug logging to web server error log (STDERR)
...
if(! defined('FILE_CACHE_SUFFIX') ) 		define ('FILE_CACHE_SUFFIX', '.blm.txt');			// What to put at the end of all files in the cache directory so we can identify them
if(! defined('FILE_CACHE_PREFIX') ) 		define ('FILE_CACHE_PREFIX', 'otodriverhumb');				// What to put at the beg of all files in the cache directory so we can identify them
